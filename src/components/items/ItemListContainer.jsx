...
const ItemListContainer = () => {
    ...
    const [range, setRange] = useState([0, 80000]);
  ...
  return (
    <div className='container_itemList'>
                ...
                <aside className='filter__aside'>
                    ...
                    <div className="filter__aside__div">
                        <div className="slider-container">
                            ...
                            <Slider className='filter__aside__div__slider' range min={0} max={80000} step={1} value={range} onChange={handleRangeChange}/>
                        </div>
                    </div>
                </aside>
        ...
        <div className='container_itemsAndPaginate'>
            <ItemList
            products= {products}
            setProducts={setProducts}></ItemList>
