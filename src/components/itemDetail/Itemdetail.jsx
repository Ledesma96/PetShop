...
const Itemdetail = () => {
    ...
    useEffect(() => {
        async function fetchProduct () {
            try {
                const response = await fetch(`http://localhost:8080/api/products/detail/${id}`)
      ...
      <div className='detail' key={product._id}>
        <section className='detail__section'>
            ...
            <div className='detail__section__div'>
                ...
                <Count stock={product.stock}></Count>
                <div className='detail__section__div__div'>
                    <svg color='rgb(255, 68, 0)' xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16">
                ...
                <div className='detail__section__div__div'>
                    <svg color='rgb(255, 68, 0)' xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
